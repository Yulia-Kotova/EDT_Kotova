...
&НаКлиенте
Асинх Процедура ДорБазы_СогласованнаяСкидкаПриИзменении(Элемент)
...
Процедура РассчитатьСуммуСтроки(ТекущиеДанные)
	...
	Скидка = Объект.ДорБазы_СогласованнаяСкидка; 
	ЦенаСоСкидкой = ТекущиеДанные.Цена - (ТекущиеДанные.Цена * Скидка/100); 
